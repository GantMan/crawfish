import React, { View, Text, TouchableOpacity, Modal, Image, TextInput, ScrollView } from 'react-native'
    ...
    return (
      ...
      >
        <ScrollView style={styles.container}>
          <View style={{backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center'}}>
            <View style={{height: 350, backgroundColor: '#383a3d', padding: 10, margin: 20, borderRadius: 5}}>
              ...
              <View style={{flexDirection: 'row', justifyContent: 'space-around', marginTop: 10, marginBottom: 10, flex: 1, alignItems: 'flex-end'}} >
                <TouchableOpacity style={[styles.button, {flex: 1, margin: 5, height: 40, backgroundColor: Colors.lightGreen}]} onPress={this.props.onPress}>
                  <Text style={{color: 'white', textAlign: 'center', alignSelf: 'center', fontSize: 18}}>Search</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.button, {flex: 1, margin: 5, height: 40, backgroundColor: Colors.crawfish}]} onPress={this.props.onPress}>
                  <Text style={{color: 'white', textAlign: 'center', alignSelf: 'center', fontSize: 18}}>Cancel</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
